...
ARG_DEFS = {
    ...
    "unitree_recon_mode": ("--unitree-recon-mode", "Recon mode",   "choice", "enumerate",
                           ["enumerate", "sniff", "vulnerabilities", "full"]),
...
CMD_ARGS = {
    ...
    "unitree-recon":  ["domain_id", "robot_model", "unitree_recon_mode", "timeout", "duration", "output", "verbose"],
    "unitree-api":    ["domain_id", "robot_model", "unitree_api_mode", "unitree_api_id",
                       "sport_vx", "sport_vy", "sport_vyaw", "duration", "output", "verbose"],
    "unitree-lowcmd": ["domain_id", "robot_model", "lowcmd_mode", "joint_tau", "joint_q",
